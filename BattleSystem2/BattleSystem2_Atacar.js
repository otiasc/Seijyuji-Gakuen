...
actions.push({uniqueId:'A18', prefix:'R7', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Espachurrar (enemigos pequeños)', bonus:new Array(
...
actions.push({uniqueId:'A2', prefix:'6', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Patada o pisotón', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A3', prefix:'X4', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Empujar', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A13', prefix:'X6', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Cabezazo', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A14', prefix:'X6', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Agarrar del cuello', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
	'-F/4|El exorcista (tú) tiene herida leve la cabeza',
	'-F/3|El exorcista (tú) tiene herida grave (lesión) en la cabeza'
...
actions.push({uniqueId:'A15', prefix:'X6', equation:'F', equation2:'Fb', name:'Atacar/Cuerpo a cuerpo/Codazo o rodillazo', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A4', prefix:'R7', equation:'1+ESG', equation2:'Fb', name:'Atacar/Arma blanca/De una mano (daga, etc.)', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A5', prefix:'R7', equation:'ESG', equation2:'Fb', name:'Atacar/Arma blanca/De dos manos (espada, etc.)', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A6', prefix:'7', equation:'F-3', equation2:'Fb', name:'Atacar/Arma cuerpo a cuerpo/Contundente (martillo, porra, etc.)', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
actions.push({uniqueId:'A7', prefix:'8', equation:'F', equation2:'Fb', name:'Atacar/Arma cuerpo a cuerpo/No contundente (bastón, vara, k\'rik, etc.)/Golpear', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
	'-F/3|El exorcista (tú) tiene herida leve en mano',
...
actions.push({uniqueId:'A10', prefix:'8', equation:'F * PUN + 1', equation2:'Fb', name:'Atacar/Arma cuerpo a cuerpo/No contundente (bastón, vara, k\'rik, etc.)/Lanzar a distancia', bonus:new Array(
...
*/
actions.push({uniqueId:'A8',prefix:'6', equation:'F * PUN - 4', equation2:'Fb', name:'Atacar/Arma de fuego/Automática (ametralladora, etc.)',  bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
...
*/
actions.push({uniqueId:'A11', prefix:'6', equation:'1+ESG', equation2:'Fb', name:'Atacar/Arma demoniaca/Espada demoniaca', bonus:new Array(
	'+1|El enemigo no te ve (ataque por sorpresa)',
	//
	'-ESG/3|El exorcista (tú) tiene herida leve en mano',
	'-ESG/2|El exorcista (tú) tiene herida grave (lesión) en mano o brazo'
...
actions.push({uniqueId:'A16', prefix:'6', equation:'F * D', equation2:'Fb', name:'Atacar/Etc/Llamas demoníacas', bonus:new Array(
...
*/
actions.push({uniqueId:'A12', prefix:'7', equation:'F * PUN + 1', equation2:'Fb', name:'Atacar/Etc/Lanzar objeto', bonus:new Array(
...
actions.push({uniqueId:'A17', prefix:'6', equation:'4', equation2:'Fb', name:'Atacar/Etc/Agua bendita', bonus:new Array(

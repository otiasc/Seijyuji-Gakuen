...
*/
actions.push({uniqueId:'D1', prefix:'B11', equation:'V', name:'Defensa propia/Alejarse', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues alejarte',
	'0: No consigues alejarte lo suficiente',
	'-1 o menos: Tropiezas y caes al suelo'
)});
actions.push({uniqueId:'D2', prefix:'B11', equation:'V', name:'Defensa propia/Esquivar al enemigo', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues alejarte',
	'0: No consigues alejarte lo suficiente',
	'-1 o menos: Tropiezas y caes al suelo'
)});
actions.push({uniqueId:'D3', prefix:'B11', equation:'D', name:'Defensa propia/Defensa ante posesión', bonus:new Array(
), results: new Array(
...
actions.push({uniqueId:'D5', prefix:'B10', equation:'V', name:'Defender a otro/Interponerse', bonus:new Array(
), results: new Array(
...
actions.push({uniqueId:'D6', prefix:'B11', equation:'I', name:'Defender a otro/Distraer', bonus:new Array(
), results: new Array(
...
actions.push({uniqueId:'D7', prefix:'B21', equation:'I', name:'Defender a otro/Llamar la atención sobre uno mismo', bonus:new Array(
), results: new Array(

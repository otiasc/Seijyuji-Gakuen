...
*/
actions.push({prefix:'0001', equation:'10', name:'Defensa propia/Alejarse', bonus:new Array(
), results: new Array(
...
actions.push({prefix:'0001', equation:'10', name:'Defender a otro/Interponerse', bonus:new Array(
), results: new Array(
...
actions.push({prefix:'0001', equation:'10', name:'Defender a otro/Distraer', bonus:new Array(
), results: new Array(
...
actions.push({prefix:'0001', equation:'10', name:'Defender a otro/Llamar la atención sobre uno mismo', bonus:new Array(
), results: new Array(

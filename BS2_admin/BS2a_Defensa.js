...
*/
actionsA.push({uniqueId:'D1', prefix:'7', equation:'V', equation2:'(V+3)/Vb', name:'Defensa propia/Alejarse', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues alejarte',
	'0: No consigues alejarte lo suficiente',
	'-1 o menos: Tropiezas y caes al suelo'
)});
actionsA.push({uniqueId:'D2', prefix:'7', equation:'V', equation2:'(V+2)/Vb', name:'Defensa propia/Esquivar al enemigo', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues alejarte',
	'0: No consigues alejarte lo suficiente',
	'-1 o menos: Tropiezas y caes al suelo'
)});
actionsA.push({uniqueId:'D3', prefix:'6', equation:'D', equation2:'D/D', name:'Defensa propia/Defensa ante posesión', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues librarte',
	'0: Te poseee'
)});
actionsA.push({uniqueId:'D4', prefix:'7', equation:'F', equation2:'F/Fb', name:'Defensa propia/Soltarte del enemigo', bonus:new Array(
), results: new Array(
	'+1 o más: Consigues soltarte',
	'0: No consigues soltarte',
	'-1 o menos: Al forcejear te dañas. No te sueltas. [u]Herida leve[/u]'
)});
actionsA.push({uniqueId:'D5', prefix:'6', equation:'V', equation2:'V/5', name:'Defender a otro/Interponerse', bonus:new Array(
), results: new Array(
...
actionsA.push({uniqueId:'D6', prefix:'X4', equation:'I', equation2:'1.1', name:'Defender a otro/Distraer', bonus:new Array(
), results: new Array(
...
actionsA.push({uniqueId:'D7', prefix:'X4', equation:'I', equation2:'0.7', name:'Defender a otro/Llamar la atención sobre uno mismo', bonus:new Array(
), results: new Array(

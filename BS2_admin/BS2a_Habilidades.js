...
/*
	CATEGORÍA Aria
*/
actionsA.push({uniqueId:'H1', prefix:'7', equation:'I', equation2:'1', name:'Aria/Versos fatales/Corto', bonus:new Array(
	'+1|Sin presión',
...
actionsA.push({uniqueId:'H2', prefix:'7', equation:'I', equation2:'1', name:'Aria/Versos fatales/Medio', bonus:new Array(
	'+1|Sin presión',
	// Repetir esquema con Atacar/Cuerpo a cuerpo/Patada
	'-I/2|Distracciones'
), results: new Array(
...
actionsA.push({uniqueId:'H3', prefix:'7', equation:'I', equation2:'1', name:'Aria/Versos fatales/Largo', bonus:new Array(
	'+1|Sin presión',
	// Repetir esquema con Atacar/Cuerpo a cuerpo/Patada
	'-I/2|Distracciones'
), results: new Array(
...
/*
	CATEGORÍA Doctor
*/
actionsA.push({uniqueId:'H4', prefix:'6', equation:'DOC', equation2:'1', name:'Doctor/Curar', bonus:new Array(
...
/*
	CATEGORÍA Tamer
*/
actionsA.push({uniqueId:'H5', prefix:'6', equation:'D*FAM', equation2:'1', name:'Tamer/Invocación de familiar', bonus:new Array(
), results: new Array(
	'+1 o más:Invocación conseguida',
	'0 o menos: Falla la invocación'
)});
actionsA.push({uniqueId:'H6', prefix:'7', equation:'D+FAM', equation2:'1', name:'Tamer/Ataque de familiar', bonus:new Array(
...
actionsA.push({uniqueId:'H7', prefix:'6', equation:'D+FAM*DOC', equation2:'1', name:'Tamer/Curación', bonus:new Array(
...
actionsA.push({uniqueId:'H8', prefix:'6', equation:'D', equation2:'1', name:'Tamer/Recuperar control de familiar', bonus:new Array(
), results: new Array(
